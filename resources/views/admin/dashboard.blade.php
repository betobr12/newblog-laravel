    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-cyan hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">TOTAL DE FAVORITOS</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-orange hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">TOTAL DE VIEWS</div>
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
            ...
            <div class="info-box bg-deep-purple hover-zoom-effect">
                ...
                <div class="content">
                    <div class="text">NOVOS AUTORES DO DIA</div>
                            ...
                            <tbody>
                                @foreach($popular_posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary waves-effect" target="_blank" href="{{ route('post.details',$post->slug) }}">Visualizar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
