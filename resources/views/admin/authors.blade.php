                            ...
                            <tbody>
                                @foreach ($authors as $key=>$author)
                                 <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $author->name }}</td>
                                    <td><span class="badge badge-info">{{ $author->posts_count}}</span></td>
                                    <td><span class="badge badge-info">{{ $author->comments_count}}</span></td>
                                    <td><span class="badge badge-info">{{ $author->favorite_posts_count}}</span></td>
